...
public class LoveShopFragment extends Fragment {

    private Unbinder unbinder;
    @BindView(R.id.recyclerView)
    RecyclerView recyclerView;
    public LoveShopFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        // Inflate the layout for this fragment  8
        return inflater.inflate(R.layout.fragment_love_shop, container, false);
    }
    @Override
