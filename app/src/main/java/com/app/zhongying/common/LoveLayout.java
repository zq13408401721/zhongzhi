package com.app.zhongying.common;
...
public class LoveLayout extends RelativeLayout {
    ...
    private void initView() {
        ...
        // 图片资源
        icons[0] = getResources().getDrawable(R.mipmap.aixin);
        icons[1] = getResources().getDrawable(R.mipmap.aixin2);
        icons[2] = getResources().getDrawable(R.mipmap.aixin3);
        icons[3] = getResources().getDrawable(R.mipmap.aixin);
        // 插值器
    ...
    private ValueAnimator getBzierAnimator(final ImageView iv) {
        ...
        valueAnim.setInterpolator((TimeInterpolator) interpolators[new Random().nextInt(4)]);
        return valueAnim;
    }
